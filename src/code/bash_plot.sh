...
python make_plots.py \
       --result_dirs $(for dir in "${results_nation_1[@]}"; do echo ../../results/"${dir}"; done) \
...
results_nation_2=( 2022_Sep_08_20_51_38 2022_Sep_08_20_52_21 2022_Sep_08_20_52_21 2022_Sep_08_20_53_46 2022_Sep_08_20_54_30 )

python make_plots.py \
     --result_dirs $(for dir in "${results_nation_2[@]}"; do echo ../../results/"${dir}"; done) \
...
python make_plots.py \
     --result_dirs $(for dir in "${results_nation_3[@]}"; do echo ../../results/"${dir}"; done) \
...
python make_plots.py \
     --result_dirs $(for dir in "${results_nation_4[@]}"; do echo ../../results/"${dir}"; done) \
